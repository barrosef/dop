...
- **Date:** 2026-09-06
- **Status:** **superseded on 2026-09-20** by [the onboarding journey](2026-09-20-onboarding-journey-design.md). The phone step is reborn as the journey's optional contact step; tools, social networks and referral are retired; plans are absorbed by the journey. Kept for the record.
